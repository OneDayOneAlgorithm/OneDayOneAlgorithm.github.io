...
09:00 ~ 09:30 게임 제작 방법 노하우 특강

09:30 ~ 11:00 socket 개발
...
- 실행명령어 처음에 nohup을 넣고 끝에 & 을 넣으니 터미널을 꺼도 백그라운드에서 프로젝트가 실행됨을 알아냈다.
...
- 오전에는 아두이노 API를 만들다 오후에는 FCM을 했다.
